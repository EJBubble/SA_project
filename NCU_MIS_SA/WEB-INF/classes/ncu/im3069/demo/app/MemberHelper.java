...
public class MemberHelper {
    ...
    public JSONObject deleteByID(int id) {
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "DELETE FROM `saproject`.`member` WHERE `id` = ? LIMIT 1";
    ...
    public JSONObject getAll() {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `saproject`.`member`";
            ...
            while(rs.next()) {
                ...
                m = new Member(member_id, email, password, name, login_times, phone);
    ...
    public boolean checkDuplicate(Member m){
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT COUNT(*) FROM `saproject`.`member` WHERE `member_email` = ?";
    ...
    public JSONObject create(Member m) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "INSERT INTO `saproject`.`member`(`member_name`, `member_password`, `member_email`, `member_phone`, `update_times`, `login_times`, `created`)"
                    + " VALUES(?, ?, ?, ?, ?, ?, ?)";
    ...
    public void updateLoginTimes(Member m) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "Update `saproject`.`member` SET `login_times` = ? WHERE `id` = ?";
            /** 取得會員編號 */
            int id = m.getID();
    ...
    public boolean checkLogin(String email, String password){
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT COUNT(*) FROM `saproject`.`member` WHERE `member_email` = ? AND `member_password` = ?";
    ...
    public JSONObject getByEmail(String Myemail) {
        /** 新建一個 Member 物件之 m 變數，用於紀錄每一位查詢回之會員資料 */
        Member m = null;
        /** 用於儲存所有檢索回之會員，以JSONArray方式儲存 */
        JSONArray jsa = new JSONArray();
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `saproject`.`member` WHERE `member_email` = ? LIMIT 1";
